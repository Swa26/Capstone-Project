...
// 'package:string_to_color/string_to_color.dart';

class NewThisWeek extends ConsumerStatefulWidget {
  //const MyGridView({super.key, this.color});
  NewThisWeek({
    super.key,
  });
  @override
  ConsumerState<NewThisWeek> createState() => _NewThisWeekState();
}

class _NewThisWeekState extends ConsumerState<NewThisWeek> {
  @override
